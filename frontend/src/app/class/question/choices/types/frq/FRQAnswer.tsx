...
import { Message, Segment, Button, TextArea, SemanticCOLORS } from 'semantic-ui-react';
...
export default function FRQAnswer({ text, choice, selectedQuestion }) {
  ...
  const loading = useSelector(selectLoadingState).loadingComps?.AiGrade;
  ...
  return (
    <Segment basic loading={loading}>
      ...
      {currentChoice?.ai_response && <AIResponseComponent responseText={currentChoice.ai_response} grade={currentChoice.grade} />}
    </Segment>
  );
}
